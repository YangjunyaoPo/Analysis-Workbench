...
The development agent reran **12 Python tests and 10 JavaScript tests** on
2026-09-15; all passed. They cover storage integrity and failure cases, HTTP
...
The new archive page still needs an interactive walkthrough. The maintainer's
...
3. Choose the next archive improvement from that walkthrough. Attachment removal,
   ZIP import, and selecting archived files as analysis inputs are not implemented.
